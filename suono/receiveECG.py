...
async def save_send_to_sound(ecg_values:str,separator:str,delayms:int): # nome della funzione in utilizzo (def= definisco) ecg_value è lo stesso servizio dall'indirizzo sopra
